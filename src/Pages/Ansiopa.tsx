        ...
        <ScrollArrow />
            ...
            <div className="outcomeImages">
                <div className="column">
                    <video src={"/GraceClehanePortfolio/videos/AnSiopaUse.mp4"} autoPlay loop muted playsInline className='outcomeImage2'></video>
                </div>
                <div className="column">
                    <img src={siopa1} alt="Snow" className='outcomeImage1'></img>
                </div>
                <div className="column">
                    <video src={"/GraceClehanePortfolio/videos/AnSiopaView.mp4"} autoPlay loop muted playsInline className='outcomeImage3'></video>
                </div>
            </div>
            ...
            <div className="processImages">
                <div className="column">
                    <video src={"/GraceClehanePortfolio/videos/Process2.mp4"} autoPlay loop muted playsInline  className='processImage4'></video>
                </div>
                <div className="column">
                    <video src={"/GraceClehanePortfolio/videos/Process5.mp4"} autoPlay loop muted playsInline  className='processImage1'></video>
                </div>
                <div className="column">
                    <video src={"/GraceClehanePortfolio/videos/Process3.mp4"} autoPlay loop muted playsInline  className='processImage3'></video>
                </div>
                <div className="column">
                    <video src={"/GraceClehanePortfolio/videos/Process.mp4"} autoPlay loop muted playsInline className='processImage2'></video>
                </div>
            </div>
            ...
            <div className="technologyImages">
                ...
                <div className="column">
                    <video src={"/GraceClehanePortfolio/videos/final2.mp4"} autoPlay loop muted playsInline  className='finalImage2'></video>
                </div>
            </div>
            </section>
